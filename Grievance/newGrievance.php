  ...
  if($_POST['GrievanceDescription'] == ""){
    ...
    elseif($_POST['Make'] == 11){
      ...
      $subdivion = "Dustbin Installation";
       ...
       $sql = "INSERT INTO `grievancesystem`.`grievancetable` (userName  , name ,recievedDate, address, mobileNo , email ,GrievanceDescription,department,subdivision,status) Values
       ('".$_SESSION['sess_user']."' , '".$name."' ,'".$date."' ,'".$address."' ,'".$mobileNo."' ,'".$email."' ,'".$_POST['GrievanceDescription']."' ,'".$division."' ,'".$subdivion."','Pending' )";
  ...
  <section class="content">
      <div class="box box-warning">
          ...
          <div class="box-body">
              ...
              <p class="text-info">
                  <strong>If you are a registered user, then login to GRA by providing Username and Password in <a href="index.php"> User Login</a> section of the home page.</strong>
              </p>
              <p class="text-orange">
